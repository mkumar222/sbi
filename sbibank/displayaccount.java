...
class displayaccount
{
	JFrame fr,mainform;
	JLabel lclose;
	JLabel p1,p2,p3,p4,p5,p6,p7,p8,p9,limg,lsearch;
	JTextField t1,t2,t3,t4,t5,t6,t7,t8;
	String path;
	Image original,scaled;	
	ResultSet rs;

	public displayaccount(JFrame mf,ResultSet r)
	{
		mainform = mf;
		rs = r;
		...
		fr.setIconImage(img);
		fr.setContentPane(new JLabel(new ImageIcon("images/searchaccount.png")));			
		fr.setLayout(null);
