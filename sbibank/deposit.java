...
class deposit implements FocusListener,ActionListener
{
	JFrame fr,fn;
	...
	public deposit(JFrame f)
	{
		...
		fr.setContentPane(new JLabel(new ImageIcon("images/depositform.png")));
		...
		b1.setBounds(225,225,90,27);	
		b2.setBounds(325,225,90,27);
			...
			else
			{
				...
				try
				{
					...
					{	 
						...
						PreparedStatement ps2 = con.prepareStatement("insert into sbi_deposit values(?,?,?,?)");
						...
						if(m>0)
						{
							...
							ps1.executeUpdate();
							JOptionPane.showMessageDialog(fr,"Amount Deposited Successfully");
						}
					}
					else
					{
